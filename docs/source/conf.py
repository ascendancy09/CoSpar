...
# nbsphinx_prolog = r"""
# {% set docname = 'github/theislab/cospar_notebooks/blob/master/' + env.doc2path(env.docname, base=None) %}
# .. raw:: html
...
#       <img src="https://github.com/theislab/cospar/raw/master/docs/source/_static/nbviewer-badge.svg" alt="Open In nbviewer"/></a>
#     </div>
# """
...
github_repo = "cospar"
github_nb_repo = "cospar_notebooks"
...
qualname_overrides = {
    ...
    "cospar.pl.scatter": "cospar.plotting.scatter",
}
