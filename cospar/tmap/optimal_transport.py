# -*- coding: utf-8 -*-
"""
This module is borrowed from Waddington-OT
...
def optimal_transport_duality_gap(C, G, lambda1, lambda2, epsilon, batch_size, tolerance, tau,
    ...
    It guarantees that the duality gap is at most `tolerance`.
    The method is twice faster than the :func:`.transport_stablev2`
